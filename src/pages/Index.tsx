...
const Index = () => {
  ...
  const addParticipant = () => {
    setFormData({
      ...formData,
      participants: [...formData.participants, { name: '', dob: '', id: Math.random() }]
    });
  };
      ...
      <div className="min-h-screen bg-background flex flex-col items-center justify-center p-6 text-center overflow-hidden relative">
        ...
        >
          ...
          <div className="space-y-4">
            <h1 className="text-5xl md:text-6xl font-serif text-foreground">The Pact is Sealed</h1>
            <p className="text-xl text-muted-foreground font-light leading-relaxed">
              Welcome to the HavFun heritage, <span className="text-primary font-medium">{formData.name}</span>. Your covenant is archived.
            </p>
          </div>
          
          <div className="flex flex-col gap-4 items-center">
            <PremiumButton onClick={() => window.print()}>
      ...
      <main className="relative max-w-7xl mx-auto px-4 md:px-6 py-20 min-h-screen flex flex-col z-10">
              ...
              {SECTIONS.map((_, idx) => (
                <motion.div 
                  ...
                  className={`h-1 w-8 rounded-full transition-all duration-700 ${
                    idx <= step ? 'bg-gradient-neon' : 'bg-muted'
                  }`}
                  initial={{ scaleX: 0 }}
                  animate={{ scaleX: 1 }}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
                ...
                <div className="lg:col-span-7">
                  ...
                  >
                            ...
                            >
                              <div className="md:col-span-7 space-y-2">
                                ...
                                <input 
                                  ...
                                  value={p.name}
                                  onChange={(e) => {
                                    const newParts = [...formData.participants];
                    ...
                    {step === 4 && (
                      <div className="space-y-10">
                        <SignaturePad onSign={(val) => setFormData({...formData, signed: val})} />
        ...
        <footer className="mt-16 pt-8 border-t border-border/40 flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="flex items-center gap-8">
            ...
            <PremiumButton onClick={nextStep} disabled={!isStepValid()}>
