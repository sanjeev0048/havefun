...
const images = [
  { src: trampolineZone, delay: 0, position: 'top-20 right-10', size: 'w-32 h-24 md:w-48 md:h-36' },
  { src: junglePlayground, delay: 0.5, position: 'top-40 right-32', size: 'w-28 h-20 md:w-40 md:h-28' },
  { src: basketballZone, delay: 1, position: 'bottom-40 right-16', size: 'w-36 h-24 md:w-52 md:h-36' },
  { src: bubbleBalls, delay: 1.5, position: 'bottom-20 right-40', size: 'w-24 h-18 md:w-36 md:h-24' },
];
